...
# Usage: Installing dependencies for cell-biology-virtual-lab-i
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /cell-biology-virtual-lab-i

COPY src/ /cell-biology-virtual-lab-i/src

WORKDIR ./cell-biology-virtual-lab-i/src
